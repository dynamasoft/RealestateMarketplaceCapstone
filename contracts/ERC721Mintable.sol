...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(isOwner(), "Owner of this contract is requied");
        _;
    }
...
contract ERC721 is Pausable, ERC165 {
    ...
    function balanceOf(address owner) public view returns (uint256) {
        ...
        require(owner != address(0), "invalid balance, the address is zero");
    ...
    function ownerOf(uint256 tokenId) public view returns (address) {
        ...
        require(owner != address(0), "the token owner doesn't exists");
        return owner;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        require(to != owner, "approval to the current owner");
    ...
    function getApproved(uint256 tokenId) public view returns (address) {
         require(_exists(tokenId), "approved query for token that doesn't exist");
...
contract ERC721Mintable is ERC721Metadata, Ownable {
    string private _name = "Smitty Real Estate Token";
    string private _symbol = "SRET";
